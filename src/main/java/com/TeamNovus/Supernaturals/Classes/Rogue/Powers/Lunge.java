...
public class Lunge extends Power {	
	private Integer maxDistance;
	
	public Lunge(String name, String desc, Integer cooldown, Reagent required, Reagent consume) {
		super(name, desc, cooldown, required, consume);	
		
		maxDistance = 255;
	}
	
	public Lunge setMaxDistance(Integer maxDistance) {
