...
public class Mage extends SNClass {
	...
	public Mage(SNClass parentClass) {
		...
		addPower(1, new Heal("Heal", "Heal youself and nearby players!", 5, 0, new Reagent(), new Reagent()));
		addPower(10, new Heal("Confuse", "Confuse an enemy!", 50, 0, new Reagent(), new Reagent()));
		addPower(30, new Heal("Thunderstorm", "Summon the storm of death upon your enemies!", 50, 0, new Reagent(), new Reagent()));
