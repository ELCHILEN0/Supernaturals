...
public class HelpCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		sender.sendMessage(ChatColor.GOLD + "<>--------------[ " + ChatColor.DARK_RED + "SupernaturalRaces" + ChatColor.GOLD  + " ]--------------<>");
		sender.sendMessage(ChatColor.YELLOW + "/races " + ChatColor.AQUA + "View all avaliable races!");
		sender.sendMessage(ChatColor.YELLOW + "/sninfo <Race> " + ChatColor.AQUA + "View a races abilities, skills and powers!");
